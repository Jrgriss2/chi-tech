...
--========== ProdQuad
--pquad = chiCreateCustomQuadrature("Test_GLC_Quad.txt", "Test_GLC_M2D.txt", "Test_GLC_D2M.txt")
pquad = chiCreateCustomQuadrature("Custom_Quad.txt", "Custom_M2D.txt", "Custom_D2M.txt")
